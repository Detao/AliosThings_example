...
typedef enum{
    STATE_INVALID = 0,                      /* MQTT in invalid state */
    STATE_INITIALIZED = 1,                  /* MQTT in iniitializing state */
    STATE_CONNECTED = 2,                    /* MQTT in connected state */
    STATE_DISCONNECTED = 3,                 /* MQTT in disconneced state */
    STATE_DISCONNECTED_RECONNECTING =4      /* MQTT in reconnecting state */
...
{
    mqtt_state_t                    client_state;                      /* state of MQTT client */
    int                             ping_mark;                         /* flag of ping */
    Timer                           next_ping_time;                    /* next of ping */
    uint8_t                         keepalive_probes;                  /* keepalive probes */
    char                           *buf_send;                          /* pointer of send bufer */
 ...
 *  @return success code
 */
DLLExport int MQTTYield(void* client, int time);
