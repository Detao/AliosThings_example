...
void board_init(void)
{
    ...
    hal_partitions[HAL_PARTITION_APPLICATION].partition_length           = 0x1C000;    //500k bytes
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_1].partition_start_addr       = 0x0801C000;
    ...
    hal_partitions[HAL_PARTITION_PARAMETER_2].partition_start_addr       = 0x0801D000;
