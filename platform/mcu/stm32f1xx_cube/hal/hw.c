...
int32_t hal_timer_finalize(timer_dev_t *tmr)
{
...
#elif defined DEV_SAL_ATK_ESP8266
    extern hal_wifi_module_t aos_wifi_module_atk_esp8266;
    hal_wifi_register_module(&aos_wifi_module_atk_esp8266);
#endif

    //hal_ota_register_module(&stm32f175_ota_module);
    hal_wifi_init();
}
