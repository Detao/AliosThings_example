...
int drv_gyro_bosch_bmg160_read(void *buf, size_t len)
{
    ...
    ret = sensor_i2c_read(&bmg160_ctx, BMG160_RATE_X_LSB_ADDR, &reg[0],
                          I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&bmg160_ctx, BMG160_RATE_X_MSB_ADDR, &reg[1],
                           I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&bmg160_ctx, BMG160_RATE_Y_LSB_ADDR, &reg[2],
                           I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&bmg160_ctx, BMG160_RATE_Y_MSB_ADDR, &reg[3],
                           I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&bmg160_ctx, BMG160_RATE_Z_LSB_ADDR, &reg[4],
                           I2C_REG_LEN, I2C_OP_RETRIES);
    ret |= sensor_i2c_read(&bmg160_ctx, BMG160_RATE_Z_MSB_ADDR, &reg[5],
                           I2C_REG_LEN, I2C_OP_RETRIES);
    if (unlikely(ret)) {
        return -1;
    }
